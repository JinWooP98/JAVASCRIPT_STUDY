...
console.log(filteredUserList[0].userName);
...
//  이름의 키값을 nickName, 나이는 old, 주소는 addr로 하고싶어
...
const someUser = userList.some (user => user.age <= 20);
console.log(someUser);

const everyUser = userList.every (user => user.address === '서울');
